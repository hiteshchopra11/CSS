...
function startAnimation() {
    if (c == 1) {
        ...
        document.getElementById("menu_two").style.animation = " menu_two_animation_reverse 1s forwards ";
        ...
        document.getElementById("menu_two").style.animation = " menu_two_animation 1s forwards ";
        document.getElementById("menu_three").style.animation =
